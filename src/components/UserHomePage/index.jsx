...
const UserHomePage = () => {
  ...
  return (
    <div className='logged-in-home-page-cont' style={{fontSize: size, lineHeight: lineSpacing, letterSpacing: spacing}}>
      { isLoggedIn && responseToken.user ? (<h1 style={{ lineHeight: lineSpacing }}> Hello, <span className='highlight'> {responseToken.user} </span> </h1>) : (<h1 style={{ lineHeight: lineSpacing }}>Welcome!</h1>)}
